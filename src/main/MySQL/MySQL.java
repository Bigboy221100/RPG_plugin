    ...
    public static void createTable() {
        if (isConnected()) {
            try {
                ...
                con.createStatement().executeUpdate("CREATE TABLE IF NOT EXISTS Characters (UUID VARCHAR(100), charname VARCHAR(100), charclass VARCHAR(100), charmoney VARCHAR(100), charlevel VARCHAR(100), charxp DOUBLE, charinv LONGTEXT, currentplaying BOOL)");
                ...
                con.createStatement().executeUpdate("CREATE TABLE IF NOT EXISTS NewsManager (id VARCHAR(100), newsTime INTEGER(100), news VARCHAR(100))");
